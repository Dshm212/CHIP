...
commands=(
  "CUDA_VISIBLE_DEVICES=2 python amb_attack_v3.py  --type random --tag last2 \
  --passport-config passport_configs/resnet18_passport_l34.json --arch resnet \
  --dataset caltech-256 --norm-type bn --exp-id 4_bn_image --pretrained-path pretrained/resnet.pth \
