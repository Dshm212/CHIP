...
#    --pretrained-path pretrained/alexnet.pth"
    ...
    # ==========CHIP==========
#      "CUDA_VISIBLE_DEVICES=1 python train_v23.py --exp-id 4_bn_image --dataset caltech-256 \
#      --passport-config passport_configs/alexnet_passport_ori.json --arch alexnet --epoch 200 \
#      --key-type image --norm-type bn --tag last3 --train-private --hash --chameleon \
#      -tf --tl-dataset caltech-101 --epoch 100 \
#      --pretrained-path pretrained/alexnet.pth"

      "CUDA_VISIBLE_DEVICES=1 python train_v23.py --exp-id 4_gn_image --dataset caltech-256 \
