...
def main():
    ...
    parser.add_argument('-d', '--dataset', default='cifar10', choices=['cifar10',
                                                                 'cifar100',
                                                                 'caltech-101',
                                                                 'caltech-256'],
                        help='training dataset (default: cifar10)')
    parser.add_argument('-n', '--norm-type', default='bn', choices=['bn', 'gn', 'in', 'none'],
    ...
    parser.add_argument('--exp-id', type=int, default=1,
                        help='experiment id')
    parser.add_argument('-t', '--tag',  default='origianl', help='tag')
