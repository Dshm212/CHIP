...
commands=(
  "CUDA_VISIBLE_DEVICES=0 python amb_attack_v3.py  --type random --tag last2 \
  --passport-config passport_configs/resnet18_passport_l34.json --arch resnet \
  --dataset cifar10 --norm-type bn --exp-id 4_bn_image --pretrained-path pretrained/resnet.pth \
