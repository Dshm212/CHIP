...
#
#    # ==========PAN==========
#    "CUDA_VISIBLE_DEVICES=2 python train_v23.py --exp-id 2_bn_image --dataset caltech-101 \
...
#    -tf --tl-dataset caltech-256 --epoch 100 \
#    --pretrained-path pretrained/alexnet.pth"
#
#    "CUDA_VISIBLE_DEVICES=2 python train_v23.py --exp-id 2_gn_image --dataset caltech-101 \
#    --passport-config passport_configs/alexnet_passport_ori.json --arch alexnet --epoch 200 \
...
#
#    # ==========TdN==========
#    "CUDA_VISIBLE_DEVICES=2 python train_v23.py --exp-id 3_bn_image --dataset caltech-101 \
#    --passport-config passport_configs/alexnet_passport_ori.json --arch alexnet --epoch 200 \
#    --key-type image --norm-type bn --tag last3 --train-private --hash \
#    -tf --tl-dataset caltech-256 --epoch 100 \
#    --pretrained-path pretrained/alexnet.pth"
#
#    "CUDA_VISIBLE_DEVICES=2 python train_v23.py --exp-id 3_gn_image --dataset caltech-101 \
#    --passport-config passport_configs/alexnet_passport_ori.json --arch alexnet --epoch 200 \
...
#    --pretrained-path pretrained/alexnet.pth"
    ...
    # ==========CHIP==========
      "CUDA_VISIBLE_DEVICES=2 python train_v23.py --exp-id bn_image --dataset caltech-101 \
...
#      "CUDA_VISIBLE_DEVICES=2 python train_v23.py --exp-id 4_gn_image --dataset caltech-101 \
#      --passport-config passport_configs/alexnet_passport_ori.json --arch alexnet --epoch 200 \
