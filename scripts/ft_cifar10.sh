...
commands=(
    ...
    # ==========PAN==========
#    "CUDA_VISIBLE_DEVICES=0 python train_v23.py --exp-id 2_bn_image --dataset cifar10 \
...
#    -tf --tl-dataset cifar100 --epoch 100 \
#    --pretrained-path pretrained/alexnet.pth"
#
#    "CUDA_VISIBLE_DEVICES=0 python train_v23.py --exp-id 2_gn_image --dataset cifar10 \
#    --passport-config passport_configs/alexnet_passport_3.json --arch alexnet --epoch 200 \
...
#    --pretrained-path pretrained/alexnet.pth"
    ...
    # ==========TdN==========
#    "CUDA_VISIBLE_DEVICES=0 python train_v23.py --exp-id 3_bn_image --dataset cifar10 \
#    --passport-config passport_configs/alexnet_passport_3.json --arch alexnet --epoch 200 \
#    --key-type image --norm-type bn --tag last3 --train-private --hash \
#    -tf --tl-dataset cifar100 --epoch 100 \
#    --pretrained-path pretrained/alexnet.pth"
#
#    "CUDA_VISIBLE_DEVICES=0 python train_v23.py --exp-id 3_gn_image --dataset cifar10 \
#    --passport-config passport_configs/alexnet_passport_3.json --arch alexnet --epoch 200 \
...
#    --pretrained-path pretrained/alexnet.pth"
    ...
    # ==========CHIP==========
#      "CUDA_VISIBLE_DEVICES=0 python train_v23.py --exp-id 4_bn_image --dataset cifar10 \
#      --passport-config passport_configs/alexnet_passport_3.json --arch alexnet --epoch 200 \
#      --key-type image --norm-type bn --tag last3 --train-private --hash --chameleon \
#      -tf --tl-dataset cifar100 --epoch 100 \
#      --pretrained-path pretrained/alexnet.pth"

      "CUDA_VISIBLE_DEVICES=0 python train_v23.py --exp-id 4_gn_image --dataset cifar10 \
