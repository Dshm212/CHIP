...
commands=(
    ...
    "CUDA_VISIBLE_DEVICES=3 python train_v23.py --exp-id gn_image --dataset caltech-101 \
    ...
    "CUDA_VISIBLE_DEVICES=3 python train_v23.py --exp-id bn_image --dataset caltech-101 \
    --passport-config passport_configs/alexnet_passport_1.json --arch alexnet --epoch 200 \
