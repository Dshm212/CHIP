...
commands=(
    ...
    "CUDA_VISIBLE_DEVICES=3 python train_v23.py --exp-id gn_image --dataset caltech-256 \
    ...
    "CUDA_VISIBLE_DEVICES=3 python train_v23.py --exp-id bn_image --dataset caltech-256 \
    --passport-config passport_configs/alexnet_passport_1.json --arch alexnet --epoch 200 \
    --key-type image --norm-type bn --tag baseline \
    --pretrained-path pretrained/alexnet.pth"
    ...
    --key-type image --norm-type gn --tag l4 --train-private \
    --pretrained-path pretrained/resnet.pth"
    ...
    "CUDA_VISIBLE_DEVICES=3 python train_v23.py --exp-id bn_image --dataset caltech-256 \
    --passport-config passport_configs/resnet_passport_l4.json --arch resnet --epoch 200 \
    --key-type image --norm-type bn --tag l4 --train-private \
    --pretrained-path pretrained/resnet.pth"
    ...
    "CUDA_VISIBLE_DEVICES=3 python train_v23.py --exp-id gn_image --dataset caltech-256 \
    --passport-config passport_configs/resnet_passport_l4.json --arch resnet --epoch 200 \
    --key-type image --norm-type gn --tag l4 --train-private --hash \
    --pretrained-path pretrained/resnet.pth"
    ...
    "CUDA_VISIBLE_DEVICES=3 python train_v23.py --exp-id bn_image --dataset caltech-256 \
    --passport-config passport_configs/resnet_passport_l4.json --arch resnet --epoch 200 \
    --key-type image --norm-type bn --tag l4 --train-private --hash \
    --pretrained-path pretrained/resnet.pth"
