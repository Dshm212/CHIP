...
commands=(
    ...
    "CUDA_VISIBLE_DEVICES=1 python train_v23.py --exp-id gn_image --dataset cifar100 \
    ...
    "CUDA_VISIBLE_DEVICES=1 python train_v23.py --exp-id bn_image --dataset cifar100 \
    --passport-config passport_configs/alexnet_passport_1.json --arch alexnet --epoch 200 \
